...
const CreateContainer = () => {
    ...
    const deleteImage = () => {
        setIsLoading(true);
        let deleteRef;
        deleteRef = ref(storage, `${imageAsset}`);
    ...
    return (
        <div className='w-full min-h-screen flex  items-center justify-center'>
            <div
                ...
                <div
                    className='group flex justify-center items-center flex-col border-2 border-dotted border-gray-300 w-full h-225 md:h-420 cursor-pointer rounded-lg'>
                    {isLoading ? (
                        <Loader/>
                    ) : (
                        <>
                                ...
                                <>
                                    <label
                                        ...
                                        <div
                                            ...
                                            <p className='text-gray-500 hover:text-gray-700'>Click here to
                                                upload</p>
                                        </div>
                                        <input
                                            type="file"
